...
if ((0,external_kolmafia_namespaceObject.myPath)() === $path(_templateObject || (_templateObject = _taggedTemplateLiteral(["community service"])))) {
  loopButton = createNewButton("Initiate Loop!", "mannyLoop", "csplaquesmall");
}

var postloopButton = "";

if (get("breakfastCompleted") === false && (0,external_kolmafia_namespaceObject.myDaycount)() === 1 && (0,external_kolmafia_namespaceObject.myPath)() === $path(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["none"])))) {
  postloopButton = createNewButton("Postloop?", "postloop", "volcoino");
}

var autoscendButton = "";

if ((0,external_kolmafia_namespaceObject.myPath)() === $path(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["standard"])))) {
...
if ((0,external_kolmafia_namespaceObject.pvpAttacksLeft)() > 0) {
  pvpButton = createNewButton("Round 1, FIGHT!", "uberpvpoptimizer; pvp loot karmic battle", "swords");
}
...
if ((0,external_kolmafia_namespaceObject.myFullness)() === (0,external_kolmafia_namespaceObject.fullnessLimit)() && (0,external_kolmafia_namespaceObject.myAdventures)() > 0 && (0,external_kolmafia_namespaceObject.myInebriety)() <= (0,external_kolmafia_namespaceObject.inebrietyLimit)()) {
